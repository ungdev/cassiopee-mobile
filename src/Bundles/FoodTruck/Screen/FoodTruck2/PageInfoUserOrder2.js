...
class PageInfoUserOrder2 extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      firstname: '',
  ...
  createOrderEtuPay = async () => {
    ...
    if ((this.state.firstname === '') | (this.state.lastname === '')) {
      ...
      const config = {
        method: 'post',
        url: 'https://gala.dev.uttnetgroup.fr/bouffe/api/vendors/Y7YSSE/orders',
        headers: {
...
export default PageInfoUserOrder2
