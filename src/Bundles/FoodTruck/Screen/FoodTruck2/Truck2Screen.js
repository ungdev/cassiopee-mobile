...
export default class Truck2Screen extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      loading: false,
  ...
  verifAmount = (price) => {
    if (price === '0.00') {
      ...
      this.props.navigation.navigate('Add Informations FT2', {
        price: price,
            ...
            >
              ...
              >
                <TouchableOpacity
                  style={styles.button}
                  onPress={() => {
                    this.props.navigation.navigate('Orders Food Truck 2')
                  }}
                >
